...
import { Bookmark, Compass, Home, Map, UserCircle } from 'lucide-react';
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              key={tab.href}
              href={tab.href}
              className={`flex flex-col items-center gap-1 rounded-xl px-2 py-1.5 text-[11px] font-semibold transition ${
