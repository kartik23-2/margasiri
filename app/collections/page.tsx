...
export default function CollectionsPage() {
  const collections = getSeasonalCollections();

  return (
    <main className="mx-auto max-w-6xl px-6 py-6">
      <section className="mb-8 rounded-3xl bg-indigo p-5 text-paper-light">
        <p className="text-xs uppercase tracking-widest text-paper/60">Seasonal discovery</p>
        <h1 className="mt-2 font-display text-4xl">Curated places for this season</h1>
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-paper/75">
          Collections refresh from the current season and place type, so repeat visits surface different trip ideas.
        </p>
      </section>
